...
Version  : 0.4.2
Release  : 53
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/gdtools_0.4.2.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/gdtools_0.4.2.tar.gz
...
%package dev
Summary: dev components for the R-gdtools package.
Group: Development
Requires: R-gdtools-lib = %{version}-%{release}
Provides: R-gdtools-devel = %{version}-%{release}
Requires: R-gdtools = %{version}-%{release}

%description dev
dev components for the R-gdtools package.
...
popd
pushd ..
cp -a gdtools buildavx512
popd
pushd ..
cp -a gdtools buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743084275
...
/usr/lib64/R/library/gdtools/NEWS.md
...
/usr/lib64/R/library/gdtools/tests/testthat/test-fonts.R
...
/usr/lib64/R/library/gdtools/tests/testthat/test-utils.R
...
/V4/usr/lib64/R/library/gdtools/libs/gdtools.so
/VA/usr/lib64/R/library/gdtools/libs/gdtools.so
