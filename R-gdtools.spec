...
Version  : 0.1.8
Release  : 1
URL      : https://cran.r-project.org/src/contrib/gdtools_0.1.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gdtools_0.1.8.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1560786984
...
/usr/lib64/R/library/gdtools/fontconfig/dummy-fonts.conf
/usr/lib64/R/library/gdtools/fontconfig/fonts.conf
...
/usr/lib64/R/library/gdtools/tests/testthat/test-font_family_exists.R
