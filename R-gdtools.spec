...
Version  : 0.2.4
Release  : 30
URL      : https://cran.r-project.org/src/contrib/gdtools_0.2.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gdtools_0.2.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644892509
